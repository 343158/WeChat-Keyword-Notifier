...
#
# This file is part of the Gradle build system.
#
...
# Determine the Java command to use with their workspaces.
if [ -n "$JAVA_HOME" ] ; then
...
if $cygwin ; then
    ...
    # We build the pattern for arguments to be converted to Windows format by cygpath
...
# Split up the JVM_OPTS And GRADLE_OPTS values into an array, then the elements can be passed as arguments to the java command
function splitJvmOpts() {
    JVM_OPTS=("$@")
}
eval "splitJvmOpts $DEFAULT_JVM_OPTS $JAVA_OPTS $GRADLE_OPTS"
JVM_OPTS[${#JVM_OPTS[*]}]="-Dorg.gradle.appname=$(basename \"$0\")"
